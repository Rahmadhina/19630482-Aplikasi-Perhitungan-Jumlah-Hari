...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnl.setBackground(new java.awt.Color(153, 255, 153));
        btnl.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        btnl.setText("LOGIN");
    ...
    private void btnlActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlActionPerformed
        if ("admin".equals(textu.getText())){
            if("admin".equals(textp.getText())){
